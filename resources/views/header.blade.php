...
<div class="w3-bar w3-black w3-cursive ">
    ...
    <div class="w3-dropdown-hover w3-right ">
        ...
        <button class="w3-button w3-black w3-padding-24" style="width:100%;" >Jayani Walpola</button>
        <div class="w3-dropdown-content w3-bar-block w3-border" style="right:0">
        <a href="#" class="w3-bar-item w3-button" style="background-color:black;">Link 1</a>

        </div>

    </div>
    <div class=" w3-right width-cart">
        <a href="#" class="w3-bar-item w3-button w3-mobile w3-padding-24">Cart(0)</a>
    </div>
</div>
